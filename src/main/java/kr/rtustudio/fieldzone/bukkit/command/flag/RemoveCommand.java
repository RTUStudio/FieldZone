package kr.rtustudio.fieldzone.bukkit.command.flag;
...
import kr.rtustudio.fieldzone.bukkit.region.RegionFlag;
...
public class RemoveCommand extends RSCommand<FieldZone> {
    ...
    protected Result execute(RSCommandData data) {
        ...
        RegionFlag flag;
        try {
            flag = RegionFlag.valueOf(flagKey.toUpperCase());
        ...
        Region updatedRegion = region.withoutFlag(flag);
        manager.updateFlags(regionName, updatedRegion.flags());
        chat().announce(message().get(player, "region.flag.remove")
