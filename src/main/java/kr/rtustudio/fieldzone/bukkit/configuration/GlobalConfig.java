    ...
    public class Wand extends ConfigurationPart {
        ...
        public class Particle extends ConfigurationPart {
            ...
            @Comment("""
                    ...
                    기둥 파티클
                    """)
            private org.bukkit.Particle pillar = MinecraftVersion.isSupport("1.20.5") ? org.bukkit.Particle.valueOf("FIREWORK") : org.bukkit.Particle.FIREWORKS_SPARK;
            ...
            public class Wave extends ConfigurationPart {
                @Comment("""
                        ...
                        기본
                        """)
                private org.bukkit.Particle normal = MinecraftVersion.isSupport("1.20.5") ? org.bukkit.Particle.valueOf("HAPPY_VILLAGER") : org.bukkit.Particle.VILLAGER_HAPPY;
                @Comment("""
                        Intersecting edges
                        교차
                        """)
